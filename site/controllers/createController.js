...
const controller = {//aca creo el controlador en base a las dos propiedades que habias creado facu 
  crearProducto:(req, res, next) =>{
    res.render("crearProducto")
  },

  guardarProducto:(req, res, next) => { //esta es la propiedad que usamos para crear un nuevo producto 
